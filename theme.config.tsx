  ...
  <span style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
    ...
    >
      <defs>
        ...
        >
          <stop offset="0" stopColor="#1e9cd7" stopOpacity=".9" />
          <stop offset=".52" stopColor="#0075be" />
    ...
    <span style={{ marginLeft: 8, fontSize: 18, opacity: 0.7 }}>Docs</span>
  </span>
);
